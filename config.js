...
//TIME
global.waktu = `${date}`
global.namabot = '⫹⫺ Artificial Intellegence v9.0.0'
global.v = '-'   
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ TIME: ${wktuwib}`
global.bottime = `ᴛ ɪ ᴍ ᴇ : ${wktuwib}`
// Sticker WM
global.packname = `☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ Artificial Intellegence`
global.author = `© 𝟸𝟶𝟸𝟷 - ²⁰²⁴`
...
//--------[WATERMARK]
global.wm = 'AI v9.0.0 汉 」' //Main WM
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘バージニティハンター˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ AI v9.0.0'
global.md = 'AI v9.0.0'
//-----[OWNER]
global.nomorown = '6285866034212'
global.owner = [
['6285866034212', 'Henz', true] // global owner 1
]
global.mods = [] // siapa partner mu? 
global.prems = ['6285866034212','6285866034212'] //premium unlimited
